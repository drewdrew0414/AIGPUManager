...
This guide connects the multilingual README files with the operational documents.
...
1. [한국어 README](ko/README.md)에서 제품 목적과 30초 Quickstart를 확인합니다.
...
1. Start from the [English README](en/README.md) for the product purpose and 30-second quickstart.
...
1. 从 [中文 README](zh/README.md) 开始，了解产品目标和 30 秒 Quickstart。
...
1. [日本語 README](ja/README.md) で目的と 30 秒 Quickstart を確認します。
